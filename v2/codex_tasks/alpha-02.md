# Codex Task: alpha-02 — Team Alpha (HP一次取得)

## 担当
東京 part2 (50 schools)

## ファイル参照
- 学校リスト: `codex_tasks/alpha-02_schools.jsonl`
...
done < ~/projects/research/jpms-db/v2/codex_tasks/alpha-02_schools.jsonl
```
...
## 進捗報告
完了時に以下を `codex_progress/alpha-02.json` に書き出してください:
