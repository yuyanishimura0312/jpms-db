# Codex Task: alpha-05 — Team Alpha (HP一次取得)

## 担当
埼玉・千葉 (59 schools)

## ファイル参照
- 学校リスト: `codex_tasks/alpha-05_schools.jsonl`
...
done < ~/projects/research/jpms-db/v2/codex_tasks/alpha-05_schools.jsonl
```
...
## 進捗報告
完了時に以下を `codex_progress/alpha-05.json` に書き出してください:
