# Codex Task: gamma-01 — Team Gamma (卒業生活躍データ連動)

## 担当
IC 上場企業役員DB (役員プロファイルから学歴抽出→中学逆引き)

## 入力データ
~/projects/research/miratuku-news-v2/data/ic.db

## 実行手順

1. IC 上場企業役員DB を読み込み、人物レコードを取得
...
- ログ: `codex_output/gamma-01.jsonl`
