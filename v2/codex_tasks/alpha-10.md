# Codex Task: alpha-10 — Team Alpha (HP一次取得)

## 担当
九州・沖縄 (48 schools)

## ファイル参照
- 学校リスト: `codex_tasks/alpha-10_schools.jsonl`
...
done < ~/projects/research/jpms-db/v2/codex_tasks/alpha-10_schools.jsonl
```
...
## 進捗報告
完了時に以下を `codex_progress/alpha-10.json` に書き出してください:
