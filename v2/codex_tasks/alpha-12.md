# Codex Task: alpha-12 — Team Alpha (HP一次取得)

## 担当
北陸・甲信越 (73 schools)

## ファイル参照
- 学校リスト: `codex_tasks/alpha-12_schools.jsonl`
...
done < ~/projects/research/jpms-db/v2/codex_tasks/alpha-12_schools.jsonl
```
...
## 進捗報告
完了時に以下を `codex_progress/alpha-12.json` に書き出してください:
