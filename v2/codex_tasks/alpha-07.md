# Codex Task: alpha-07 — Team Alpha (HP一次取得)

## 担当
愛知・静岡・岐阜 (37 schools)

## ファイル参照
- 学校リスト: `codex_tasks/alpha-07_schools.jsonl`
...
done < ~/projects/research/jpms-db/v2/codex_tasks/alpha-07_schools.jsonl
```
...
## 進捗報告
完了時に以下を `codex_progress/alpha-07.json` に書き出してください:
