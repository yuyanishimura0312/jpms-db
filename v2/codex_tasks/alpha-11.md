# Codex Task: alpha-11 — Team Alpha (HP一次取得)

## 担当
北海道・東北 (21 schools)

## ファイル参照
- 学校リスト: `codex_tasks/alpha-11_schools.jsonl`
...
done < ~/projects/research/jpms-db/v2/codex_tasks/alpha-11_schools.jsonl
```
...
## 進捗報告
完了時に以下を `codex_progress/alpha-11.json` に書き出してください:
