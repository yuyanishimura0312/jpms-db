# Codex Task: alpha-06 — Team Alpha (HP一次取得)

## 担当
大阪・兵庫・京都 (49 schools)

## ファイル参照
- 学校リスト: `codex_tasks/alpha-06_schools.jsonl`
...
done < ~/projects/research/jpms-db/v2/codex_tasks/alpha-06_schools.jsonl
```
...
## 進捗報告
完了時に以下を `codex_progress/alpha-06.json` に書き出してください:
