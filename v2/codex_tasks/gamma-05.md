# Codex Task: gamma-05 — Team Gamma (卒業生活躍データ連動)

## 担当
AL 学術ランドスケープ (論文著者→学歴)

## 入力データ
~/projects/research/academic-landscape-db/data/

## 実行手順

1. AL 学術ランドスケープ を読み込み、人物レコードを取得
...
- ログ: `codex_output/gamma-05.jsonl`
