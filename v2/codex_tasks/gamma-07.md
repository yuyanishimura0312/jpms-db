# Codex Task: gamma-07 — Team Gamma (卒業生活躍データ連動)

## 担当
SGRD 産学R&D (R&D責任者→学歴)

## 入力データ
~/projects/research/miratuku-news-v2/data/sgrd.db

## 実行手順

1. SGRD 産学R&D を読み込み、人物レコードを取得
...
- ログ: `codex_output/gamma-07.jsonl`
