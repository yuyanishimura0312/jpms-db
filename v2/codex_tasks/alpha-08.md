# Codex Task: alpha-08 — Team Alpha (HP一次取得)

## 担当
関西残り (14 schools)

## ファイル参照
- 学校リスト: `codex_tasks/alpha-08_schools.jsonl`
...
done < ~/projects/research/jpms-db/v2/codex_tasks/alpha-08_schools.jsonl
```
...
## 進捗報告
完了時に以下を `codex_progress/alpha-08.json` に書き出してください:
